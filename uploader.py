...
def make_request(session: requests.Session, data: Dict[str, Any], retries: int = 3):
    ...
    for _ in range(retries):
        try:
            response = session.post('http://localhost:9091/transmission/rpc', json=data)
...
def check_file_extensions(uri: Union[str, List[str]]):
    ...
    #             print("extensions found: ", any(n['n'].endswith(ext) for ext in EXCLUDED_EXTENSIONS))
    #             return True
    #     return False
    # else:
    resp = fetch_torrent_metadata(uri)
    print("extensions found: ", resp)
...
r = check_file_extensions("magnet:?xt=urn:btih:6B9C8CBB60DE0D868398625CF1FD676C010C8F04&dn=The+Sound+of+Music+%281965%29+2160p+SDR+DTS-HD+MULTI+%28moviesbyrizzo%29&tr=udp%3A%2F%2Ftracker.coppersurfer.tk%3A6969%2Fannounce&tr=udp%3A%2F%2F9.rarbg.to%3A2920%2Fannounce&tr=udp%3A%2F%2Ftracker.opentrackr.org%3A1337&tr=udp%3A%2F%2Ftracker.internetwarriors.net%3A1337%2Fannounce&tr=udp%3A%2F%2Ftracker.leechers-paradise.org%3A6969%2Fannounce&tr=udp%3A%2F%2Ftracker.coppersurfer.tk%3A6969%2Fannounce&tr=udp%3A%2F%2Ftracker.pirateparty.gr%3A6969%2Fannounce&tr=udp%3A%2F%2Ftracker.cyberia.is%3A6969%2Fannounce")
# print(r)