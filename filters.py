...
def remove_unwanted_chars(title: str) -> str:
    ...
    -------
    str
        Title with unwanted characters removed.
    """
...
def remove_leading_period(title: str) -> str:
    """
    Remove leading period from title.
    ...
    -------
    str
        Title with leading period removed.
    """
